...
1. **Parse args**: `/theteam review [--n=N] [--providers=...] [--target=...] [--persona=...] [--yes] [trailing text]`. Default N=3 (cap 8). Default providers=claude. `--yes` (aliases `-y`, `--no-confirm`, `--do-not-confirm`) skips confirm.
